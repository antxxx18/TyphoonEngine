...
namespace TE
{
	ID3D11Buffer* Buffer::CreateVertexBuffer(ID3D11Device* device, int size, bool dynamic, void const * Mem)
	{
	...
	ID3D11Buffer* Buffer::CreateIndexBuffer(ID3D11Device* device, int size, bool dynamic, void const * Mem)
	{
